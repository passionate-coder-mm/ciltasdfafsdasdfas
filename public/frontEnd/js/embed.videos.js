  ...
  $.fn.embedVideo = function(options) {
    $(this).each(function() {
      var settings = $.extend({
            uiconf : '11601208',
            wid : '102',
            //ayshaServerURL: 'http://cloudvideo.cdn.net.co',
            ...
            video_src: ($(this).data('source')) ? $(this).data('source') : 'aysha',
            extra_params: ($(this).data('params')) ? $(this).data('params') : false,
            cc_policy: ($(this).data('cc-policy')) ? $(this).data('cc-policy') : false,

            //play : '<svg enable-background="new 0 0 34 34" height="34px" id="Layer_1" version="1.1" viewBox="0 0 34 34" width="34px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M17.078,0.25c-9.389,0-17,7.611-17,17s7.611,17,17,17s17-7.611,17-17S26.467,0.25,17.078,0.25z M14,23.963  V10.537l9,6.713L14,23.963z" fill="#361063" /></svg>',

            play : '<i class="fas fa-play"></i>',

            //play : '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve"><g><g id="play-circle-fill"><path d="M255,0C114.75,0,0,114.75,0,255s114.75,255,255,255s255-114.75,255-255S395.25,0,255,0z M204,369.75v-229.5L357,255    L204,369.75z" fill="#361063"/></g></g></svg>',
            playWidth: '100px',
            playHeight: '100px',
            playOpacity: '0.7'
          }, options);
      ...
      if (settings.video_src == 'aysha') {
        if (!window.ayshaLoaded) {
          var script = document.createElement('script');
          script.type = 'text/javascript';
          script.src = settings.ayshaServerURL + '/p/' + settings.wid + '/sp/' + settings.wid + '00/embedIframeJs/uiconf_id/' + settings.uiconf + '/partner_id/' + settings.wid;
          document.getElementsByTagName('head')[0].appendChild(script);

          window.ayshaLoaded = true;
        }
      ...
      playButton.click(function() {
        ...
        playButton.fadeOut(function() {
          $(this).remove();
          if (settings.video_src == 'aysha' && window.ayshaLoaded) {
            kWidget.embed({
              'targetId' : m,
              'wid' : '_' + settings.wid,
